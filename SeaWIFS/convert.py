...
of SeaWIFS chlorophyll and convert them into a format which is compliant with
the ILAMB system.

The listing of files can be obtained by running:

wget -q --post-data="results_as_file=1&sensor_id=6&dtid=1123&sdate=1997-09-0400:00:00&edate=2010-12-1100:00:00&subType=1&prod_id=chlor_a&resolution_id=9km&period=MC" -O -https://oceandata.sci.gsfc.nasa.gov/api/file_search

We chose the monthly file using the most data, and insert nan's for September
...
def download_file(remote_source: str):
    """Download the source and show a progress bar."""
